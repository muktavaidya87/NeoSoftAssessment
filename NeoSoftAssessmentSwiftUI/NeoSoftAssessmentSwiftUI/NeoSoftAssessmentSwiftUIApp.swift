//
//  NeoSoftAssessmentSwiftUIApp.swift
...
// Create ViewModel
let viewModel = SwiftUICarouselViewModel(dataModel: dataModel, itemStatistics: itemStatistics)



@main
struct NeoSoftAssessmentSwiftUIApp: App {
    var body: some Scene {
        WindowGroup {
            SwiftUICarouselView(viewModel: viewModel)
        }
    }
}
